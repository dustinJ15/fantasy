...
- **Projections are borrowed.** 60% FantasyPros consensus + 40% ESPN. Same information everyone has.
...
4. **Vegas + weather into projections.** Scale player mu by (team implied total / league-average implied total)^k; apply wind >15 mph penalty to passing/K. Data is already cached; it's a ~50-line change in `projections.py`.
